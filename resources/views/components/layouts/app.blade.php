...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="d-flex">
        <!-- Sidebar -->
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light border-end" style="width: 280px; height: 100vh;">
            <!-- Brand -->
            ...
            <div class="dropdown d-none d-lg-block mt-3">
                ...
                <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                    ...
                    <li><a wire:navigate class="dropdown-item active" href="{{route('profile.edit')}}">Profile</a></li>
